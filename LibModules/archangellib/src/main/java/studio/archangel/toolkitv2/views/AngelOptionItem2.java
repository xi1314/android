...
public class AngelOptionItem2 extends AngelMaterialLinearLayout {
    //    Context c;
...
//    }
    ...
    public AngelOptionItem2(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.view_option_item2, this);
...
//        }
        ...
        tv_content.setTextColor(color_text);
...
//        }
        ...
        iv_arrow.setVisibility(b ? View.VISIBLE : View.GONE);
...
//        }
    ...
    public static void setDefaultArrowRes(int default_arrow_res) {
        AngelOptionItem2.default_arrow_res = default_arrow_res;
    }
    ...
    public static void setDefaultIconBackRes(int default_icon_back_res) {
        AngelOptionItem2.default_icon_back_res = default_icon_back_res;
    }
    ...
    public static void setDefaultIconRadius(int default_icon_radius) {
        AngelOptionItem2.default_icon_radius = default_icon_radius;
    }
    ...
    public static void setDefaultIconPadding(int default_icon_padding) {
        AngelOptionItem2.default_icon_padding = default_icon_padding;
    }
}
