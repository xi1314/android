...
//        Logger.out(item);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        return swipe_enabled && super.onTouchEvent(event);
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        return swipe_enabled && super.onInterceptTouchEvent(event);
    }

    public void setEnableSwipe(boolean b) {
        this.swipe_enabled = b;
    }
}
