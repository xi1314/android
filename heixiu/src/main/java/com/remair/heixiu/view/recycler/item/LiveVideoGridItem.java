 ...
 * 修改备注：
 */
public class LiveVideoGridItem extends SimpleItem<LiveVideoBean> {
    ...
    public LiveVideoGridItem(Context context, View.OnClickListener itemOnClick) {
