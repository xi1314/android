 ...
 * 修改备注：
 */
public class FollowInfoItem extends SimpleItem<PrivateMessage> {
    ...
    public FollowInfoItem(Context context, View.OnClickListener itemOnClick) {
        mContext = context;
    ...
    public void handleData(PrivateMessage privateMessage, int i) {
        ConcernInfoDB concerinfo = (ConcernInfoDB) privateMessage;
        ...
        try {
            ...
            if ("-1".equals(concerinfo.getHxtype())) {
                ...
                HXImageLoader.loadImage(chat_img, poto, Utils.getPX(42), Utils
                        .getPX(42));
