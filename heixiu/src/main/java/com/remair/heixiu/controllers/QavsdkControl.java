...
public class QavsdkControl {
    ...
    public AVContextControl mAVContextControl = null;
    ...
    public QavsdkControl(Context context) {
        ...
        Logger.out("WL_DEBUG QavsdkControl");
    }
     ...
     */
    public int startContext(String identifier, String usersig, String tag) {
        if (mAVContextControl == null) {
            return DemoConstants.DEMO_ERROR_NULL_POINTER;
        }
        return mAVContextControl.startContext(identifier, usersig, tag);
    }
     ...
     */
    public void enterRoomCreater(int relationId, String roomRole, boolean isAutoCreateSDKRoom, int videoRecvMode) {

        if (mAVRoomControl != null) {
            mAVRoomControl.enterRoomCreater(relationId, roomRole, isAutoCreateSDKRoom, videoRecvMode);
        }
    }
     ...
     * @param relationId 讨论组号
     */
    public void enterRoomViewer(int relationId, String roomRole, boolean isAutoCreateSDKRoom, int videoRecvMode) {

        if (mAVRoomControl != null) {
            mAVRoomControl.enterRoomvViewer(relationId, roomRole, isAutoCreateSDKRoom, videoRecvMode);
        }
    }
    ...
    public void enableDefaultRender() {
        if (mAVUIControl != null)
            //   DemoConstants.DEMO_ERROR_NULL_POINTER;
    ...
    public void setBackground(String identifier, int videoSrcType, Bitmap bitmap, boolean needRenderVideo) {
        if (mAVUIControl != null)
            //   DemoConstants.DEMO_ERROR_NULL_POINTER;
            mAVUIControl.setBackground(identifier, videoSrcType, bitmap, needRenderVideo);
    }
    ...
    public void setAvContext(AVContext avContext) {
        if (mAVContextControl == null) return;
        mAVContextControl.setAvContext(avContext);
    }
    ...
    public void onCreate(Context context, View contentView) {
        mAVUIControl = new AVUIControl(context, contentView.findViewById(R.id.av_video_glview));
    ...
    public void registAudioDataCallback1() {
        if (null != mAVAudioControl) {
            mAVAudioControl.registAudioDataCallback1();
        }
    }

    public void unregistAudioDataCallback1() {
        if (null != mAVAudioControl) {
            mAVAudioControl.unregistAudioDataCallback1();
        }
    }
    ...
    public int getVideoRecvMode() {
        if (mAVRoomControl == null) return AVRoom.VIDEO_RECV_MODE_MANUAL;
        return mAVRoomControl.getVideoRecvMode();
    }
}