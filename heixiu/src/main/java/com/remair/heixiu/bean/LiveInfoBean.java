...
public class LiveInfoBean implements Parcelable {
    ...
    protected LiveInfoBean(Parcel in) {
    ...
    public static final Parcelable.Creator<LiveInfoBean> CREATOR = new Parcelable.Creator<LiveInfoBean>() {
        @Override
        public LiveInfoBean createFromParcel(Parcel source) {return new LiveInfoBean(source);}


        @Override
        public LiveInfoBean[] newArray(int size) {return new LiveInfoBean[size];}
    };
}