package com.remair.heixiu.pull_rectclerview.widget;
...
public class RefreshHeader extends FrameLayout implements PtrUIHandler {
    ...
    private ImageView ptr_classic_header_left;
    private View mRotateView;
    private View mLl_pull;
    private long mLastUpdateTime = -1;
    private ImageView ptr_classic_header_right;
...
//        buildAnimation();
        ...
        mLl_pull = header.findViewById(R.id.ll_pull);

        ptr_classic_header_left = (ImageView) header.findViewById(R.id.ptr_classic_header_left);
        ptr_classic_header_right = (ImageView) header.findViewById(R.id.ptr_classic_header_right);
        animateDrawableleft = (AnimationDrawable) getContext().getResources().getDrawable(R.drawable.anim_bat_left);
        animateDrawableright = (AnimationDrawable) getContext().getResources().getDrawable(R.drawable.anim_bat_right);
