package com.remair.heixiu.pull_rectclerview;
...
import com.remair.heixiu.pull_rectclerview.listener.LoadMoreRecyclerListener;
import com.remair.heixiu.pull_rectclerview.listener.OnBothRefreshListener;
import com.remair.heixiu.pull_rectclerview.listener.OnLoadMoreListener;
import com.remair.heixiu.pull_rectclerview.listener.OnPullDownListener;
...
public class RefreshRecyclerView extends PtrFrameLayout {
    ...
    private void init() {
        ...
        //mRecyclerView.setBackgroundResource(R.color.char_color);
        //mRecyclerView.setBackgroundResource(R.drawable.list_blank_bg_att);
