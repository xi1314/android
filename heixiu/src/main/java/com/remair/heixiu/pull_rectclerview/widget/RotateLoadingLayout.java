...
public class RotateLoadingLayout extends RefreshLoadingLayout {
    ...
    protected void init() {
        ...
        imageDrawable = mContext.getResources().getDrawable(R.drawable.default_ptr_rotate);
    ...
    protected void onResetImpl() {
        ...
        mImage.setImageDrawable(getResources().getDrawable(R.drawable.refresh_complete));
